...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8">
        <title>LSB-163 - ${product.name}</title>
                        ...
                        <div class="row g-4 fruite">
                                    ...
                                    <c:forEach var="factory" items="${factories}">
                                        <li>
                                            <div class="d-flex justify-content-between fruite-name">
                                                <a href="#"><i class="fas fa-apple-alt me-2"></i>${factory}</a>
                                            </div>
                                        </li>
                                    </c:forEach>
                                </ul>
                            ...
                            <c:forEach var="product" items="${products}">
                                <div class="d-flex align-items-center justify-content-start">
                                    ...
                                    <div>
                                        <h6 class="mb-2"><a href="/product/${product.id}" class="text-decoration-none text-dark">
                                                                ${product.name}
                                                            </a></h6>
